module ApplicationHelper
  def default_meta_tags
    {
      title: 'ホットスナック美術館',
      description: 'ホットスナック私立美術館は、コンビニのレジ横でホットスナックがじっくり選べないという社会課題を解決するために開館されました。美術品のように額縁に入ったホットスナックをじっくり鑑賞し、コンビニ横の息苦しさから解放されよう♪',
