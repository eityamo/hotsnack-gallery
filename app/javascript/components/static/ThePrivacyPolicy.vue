<template>
    <v-dialog v-model="isVisible" max-width="800" scrollable @click:outside="hundleClosePrivacyPolicyModal">
        <v-card class="privacy-policy">
            <v-card-text style="height: 90%">
                ...
                <h2>情報を利用する目的</h2>
                <p>本サービスは、ユーザーから取得した情報を以下の目的のために利用します。</p>
                <ul>
